...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\t.pb.OrderR\x06orders2u\n" +
	"\fOrderService\x122\n" +
	"\vCreateOrder\x12\x16.pb.CreateOrderRequest\x1a\t.pb.Order\"\x00\x121\n" +
	"\n" +
	"ListOrders\x12\t.pb.Blank\x1a\x16.pb.ListOrdersResponse\"\x00B\x18Z\x16internal/infra/grpc/pbb\x06proto3"
